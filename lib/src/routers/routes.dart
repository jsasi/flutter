...
class BwSpRoutes {
  ...
  static final routes = {
    ...
    /// 优惠详情
    BwSpRoutes.discountDetails: (context, arguments) =>DiscountDetailsPage(data: arguments),

    /// 赞助详情
    BwSpRoutes.sponsorDetails: (context,arguments) =>
        SponsorDetailsPage(title: arguments[SponsorDetailsPage.KEY_TITLE],url: SponsorDetailsPage.KEY_URL,),
    ...
    /// 客服页面
    BwSpRoutes.customerService: (context, arguments) =>CustomerServicePage(url:arguments),


    /// web
    BwSpRoutes.webPage: (context,arguments) =>
        WebPage(title:arguments[WebPage.KEY_URL], url: arguments[WebPage.KEY_URL],),
    ...
    BwSpRoutes.photoGallery: (context, arguments) =>
        PhotoViewGalleryScreen(files:arguments[PhotoViewGalleryScreen.KEY_FILES],imgUrls: arguments[PhotoViewGalleryScreen.KEY_IMG_URLS],index: arguments[PhotoViewGalleryScreen.KEY_INDEX],),
    ...
    /// 订单详情
    BwSpRoutes.depositOrder: (context, arguments) =>DepositOrderPage(data: arguments),
  };
